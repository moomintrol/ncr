...
// function allInfoOrder() {
//   let date_start = document.querySelectorAll(".date_start");
//   let date_end = document.querySelectorAll(".date_end");
//   let car_id = document.querySelectorAll(".car_id");
//   let products = [];
//   car_id.forEach((item) => {
